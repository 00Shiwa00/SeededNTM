...
#original Code from https://github.com/google-research/uda/tree/master/text/augmentation

#changes done by Eric Kropf (00Shiwa00):
# - removed flags module
# - removed example.word_list_a and example.word_list_b for compatible reasons: given example only have list of words
#   - changes corresponding to these changes
  ...
  def replace_tokens(self, word_list, replace_prob):
    ...
    for i in range(len(word_list)):
      ...
      if self.get_random_prob() < replace_prob[i]:
        newWordList.append(self.get_random_token())
      else:
        newWordList.append(word_list[i])
    return newWordList
